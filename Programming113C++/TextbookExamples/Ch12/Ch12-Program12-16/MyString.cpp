...
* C_String      Copies underlying C-String array to caller's C-String array
...
//*********************************************************
// OIbserver Method: C_String(char*,int)                  *
//                                                        *
// Copies "this" C-String elements to the caller' "char"  *
// array up to the max size specified. The callre's array *
// is then "NULL" terminated.                             *
//                                                        *
// Pre-Condition:                                         *
// Caller's array is "maxSize" + 1 (accommodates "NULL")  *
//                                                        *
// Returns: true: All "this", C-String characters copied  *
//          false: Only "maxSize" characters copied       *
//*********************************************************
bool MyString::C_String(char* array, int maxSize) const
{
	bool allCopied;
	int copyLength;
