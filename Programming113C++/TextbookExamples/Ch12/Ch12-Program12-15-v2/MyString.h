...
* Class Description
* -----------------
* This version of the "MyString" class is the same as the file in the 1st
* version of the textbook, Program 12-15 example, except that display
* statements have been included in the two class Constructors, the Class Copy
* Constructor, and the class Destructor. These dispolay statements have been
* included soleyly for demonstration purposes. As the program is executed,
* objects that are created, copied, and destructed as they go out of scope are
* documented.
*
