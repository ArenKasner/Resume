...
*       Method                              Description
* ------------------- ---------------------------------------------------------
* Budget2             Default Constructor: Budget set to 0.00
...
public:
	...
	//       Adds a validated budget value to a Class
	//       object's, non-static budget value
	void addDivisionBudget(double budgetValue);
	//
	//    B. Method: addMainOfficeBudget(double)
