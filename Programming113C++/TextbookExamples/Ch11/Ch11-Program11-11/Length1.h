...
* All      operator++   Prefix Increment      operator++()
* All      operator++   Postfix Increment     operator++(int)
* All      operator<<   Stream Insertion Operator
* All      operator>>   Stream Extraction Operator
*
*******************************************************************************
*/class Length
{
...
public:
	...
	{ return lengthInches % INCHES_PER_FOOT; }
	//
	// 4. Instance Overloaded Operators
	...
	friend ostream& operator<<(ostream& l, Length r);
	friend istream& operator>>(istream&, Length& r);
